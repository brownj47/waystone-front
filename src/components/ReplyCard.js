	...
	return (
		<div className="py-4 px-2 m-2">
			...
			<input
				...
				name="email"
				id="comment"
				className="block w-full min-w-0 flex-1 py-2 rounded-none rounded-r-md shadow-lg bg-zinc-100 border-gray-900 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
